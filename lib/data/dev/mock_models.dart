...
class DevMockModels {
  ...
  static Map<String, dynamic> sampleAnswers() {
    return {
      ...
      AnamnesisKeys.smokingStatus: 'atual',
      ...
      AnamnesisKeys.session1Date: DateTime(2026, 4, 15),
      AnamnesisKeys.session1: 'Limpeza de pele profunda',
      AnamnesisKeys.session2Date: DateTime(2026, 4, 22),
      AnamnesisKeys.session2: 'Peeling enzimatico',
      AnamnesisKeys.session3Date: DateTime(2026, 4, 29),
      AnamnesisKeys.session3: 'Hidracao intensiva',
      AnamnesisKeys.session4Date: DateTime(2026, 5, 6),
      AnamnesisKeys.session4: 'Microagulhamento facial',
      AnamnesisKeys.session5Date: DateTime(2026, 5, 13),
      AnamnesisKeys.session5: 'LED terapia',
      AnamnesisKeys.session6Date: DateTime(2026, 5, 20),
      AnamnesisKeys.session6: 'Peeling de manutencao',
      AnamnesisKeys.session7Date: DateTime(2026, 5, 27),
      AnamnesisKeys.session7: 'Controle fotografico',
      AnamnesisKeys.session8Date: DateTime(2026, 6, 3),
      AnamnesisKeys.session8: 'Reavaliacao global',
      AnamnesisKeys.session9Date: DateTime(2026, 6, 10),
      AnamnesisKeys.session9: 'Sessao complementar',
      AnamnesisKeys.session10Date: DateTime(2026, 6, 17),
