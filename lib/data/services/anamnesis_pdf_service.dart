          ...
          _buildSection('Avaliação da Pele', [
            _buildSubSection('BIOTIPO CUTANEO', [
              _buildSubSection('Pele Oleosa (Lipídica)', [
                _pairLine(
                  'Sensível',
                  _checkboxSymbol(answers['peleOleosaSensivel']),
                  'Resistente',
                  _checkboxSymbol(answers['peleOleosaResistente']),
                ),
                _pairLine(
                  'Pigmentada',
                  _checkboxSymbol(answers['peleOleosaPigmentada']),
                  'Não pigmentada',
                  _checkboxSymbol(answers['peleOleosaNaoPigmentada']),
                ),
                _pairLine(
                  'Firme',
                  _checkboxSymbol(answers['peleOleosaFirme']),
                  'Propensa à rugas',
                  _checkboxSymbol(answers['peleOleosaRugas']),
                ),
              ]),
              ...
              _buildSubSection('Pele Seca (Alípica)', [
                _pairLine(
                  'Sensível',
                  _checkboxSymbol(answers['peleSecaSensivel']),
                  'Resistente',
                  _checkboxSymbol(answers['peleSecaResistente']),
                ),
                _pairLine(
                  'Pigmentada',
                  _checkboxSymbol(answers['peleSecaPigmentada']),
                  'Não pigmentada',
                  _checkboxSymbol(answers['peleSecaNaoPigmentada']),
                ),
                _pairLine(
                  'Firme',
                  _checkboxSymbol(answers['peleSecaFirme']),
                  'Propensa à rugas',
                  _checkboxSymbol(answers['peleSecaRugas']),
                ),
              ]),
              pw.SizedBox(height: 8),
              _buildSubSection('Pele Mista', [
                _pairLine(
                  'Sensível',
                  _checkboxSymbol(answers['peleMistaSensivel']),
                  'Resistente',
                  _checkboxSymbol(answers['peleMistaResistente']),
                ),
                _pairLine(
                  'Pigmentada',
                  _checkboxSymbol(answers['peleMistaPigmentada']),
                  'Não pigmentada',
                  _checkboxSymbol(answers['peleMistaNaoPigmentada']),
                ),
                _pairLine(
                  'Firme',
                  _checkboxSymbol(answers['peleMistaFirme']),
                  'Propensa à rugas',
                  _checkboxSymbol(answers['peleMistaRugas']),
                ),
              ]),
            ]),
            pw.SizedBox(height: 12),
            ...
            _buildSubSection('OUTROS', [
              _pairLine(
                'DERMATITE',
                _checkboxSymbol(answers['dermatite']),
                'PSORIASE',
                _checkboxSymbol(answers['psoriase']),
              ),
